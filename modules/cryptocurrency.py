...
class CryptoCurrency(commands.Cog, name="Cryptocurrency"):
    ...
    async def coin_price(self, ctx, ticker: str = "btc", fiat_currency: typing.Optional[str] = "usd"):
        ...
        if id:
            ...
            price_change_percentage_1h = str(market_info["price_change_percentage_1h_in_currency"]) + "%"
            price_change_percentage_24h = str(market_info["price_change_percentage_24h_in_currency"]) + "%"
            price_change_percentage_7d = str(market_info["price_change_percentage_7d_in_currency"]) + "%"
            price_change_percentage_1y = str(market_info["price_change_percentage_1y_in_currency"]) + "%"
